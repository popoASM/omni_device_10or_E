...
#
	...
	export OF_MAINTAINER="POPO"
	export OF_TARGET_DEVICES="land,rolex,ugg,ugglite,olive,olivelite,olivewood,mido,vince,rova,santoni,riva,E,holland1"
	export TARGET_DEVICE_ALT="land,rolex,ugg,ugglite,olive,olivelite,olivewood,mido,vince,rova,santoni,riva,E,holland1"
